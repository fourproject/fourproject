			...
			<div class="ui_content">
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						?>
							<tr>
								<td><input type="checkbox" name="check[]" value="<?php echo $val['m_id'];?>"/></td>
								<td><?php echo $val['m_id'];?></td>
								<td><?php echo $val['u_name'];?></td>
								<td><?php echo $val['m_title'];?></td>
								<td><?php echo $val['m_row'];?></td>						
								<td>
							
								
									<a href="javascript:void(0)" id="<?php echo $val['m_id'];?>" onclick="upd(this)">通过</a> ||
									<a href="javascript:void(0)" id="<?php echo $val['m_id'];?>" onclick="upd1(this)">不通过</a>
...
//批量通过
	function pt(){
		...
		//alert(str)
		var data={"str":n_str};
        var url="index.php?r=messagecheck/pass";
        $.get(url,data,function(msg){
            //<p></p>alert(msg)
            if(msg==1)
            {
...
function upd(obj){
	...
	$.ajax({
	   type: "GET",
	   url: "index.php?r=messagecheck/upd",
	   data: "id="+id,
...
function upd1(obj){
	...
	$.ajax({
	   type: "GET",
	   url: "index.php?r=messagecheck/upd1",
	   data: "id="+id,
	   success: function(msg){
		 if(msg==2){
			alert("审核不通过");
